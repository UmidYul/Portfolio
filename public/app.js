(() => {
    const translations = {
        ...
        ru: {
            ...
            "projects.higherwaist.title": "Higher Waist",
            "projects.higherwaist.desc": "Интернет-магазин ателье с полноценной админкой для учёта товаров, обработки заказов и управления продажами.",
            "projects.zedly.title": "Zedly",
            "projects.zedly.desc": "Единая цифровая среда для учеников, учителей и администраторов: тесты, аналитика и управление учебным процессом в одном месте.",
